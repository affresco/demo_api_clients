...
from deribit.support.settings import (DEFAULT_CURRENCY,
                                                DEFAULT_DEPTH)

from .base import DeltaBaseClient
...
class DeltaRequestClient(DeltaBaseClient):

    def __init__(self, url, key, secret, **kwargs):

        # Base uri
        self.__url = url
        super(DeltaRequestClient, self).__init__(key=key, secret=secret)
